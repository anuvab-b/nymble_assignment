              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                      labelText: "Search", hintText: "Search by Song, Artist"),
                ),
                const SizedBox(height: 16.0),
                Expanded(
                    child: state.searchMusicList.isNotEmpty
                        ? ListView.builder(
                            physics: const BouncingScrollPhysics(),
                            itemBuilder: (ctx, index) {
                              MusicModel musicModel =
                                  state.searchMusicList[index];
                              return ListTileWidget(
                                musicModel: musicModel,
                                onTap: () {
                                  homeBloc.add(
                                      ListItemPress(selectedModel: musicModel));
                            ...
                            itemCount: state.searchMusicList.length,
                          )
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Padding(
                                    ...
                                    child: CommonText(
                                        value:
                                            "It seems we have no results for what you're searching for. Try again",
